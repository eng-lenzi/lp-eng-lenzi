		...
		>
			...
			<nav aria-label="Links internos de áreas" className="mt-8 rounded-lg border border-border/60 bg-muted/30 p-4">
				...
				<div className="flex flex-col sm:flex-row gap-1 sm:gap-8 text-sm">
					<a href="#servicos" className="flex items-center justify-between py-2 text-primary hover:underline sm:py-0 sm:justify-start" onClick={(e) => scrollToSection(e, "servicos")}>
					...
					<a href="#credenciais" className="flex items-center justify-between py-2 text-primary hover:underline sm:py-0 sm:justify-start" onClick={(e) => scrollToSection(e, "credenciais")}>
