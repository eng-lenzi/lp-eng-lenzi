		...
		<AnimatedSection id="ensaios" aria-labelledby="ensaios-title" className="border-t py-12 sm:py-16 lg:py-24" delay={0.1}>
			...
			<nav aria-label="Links internos de ensaios" className="mt-8 rounded-lg border border-border/60 bg-muted/30 p-4">
				...
				<div className="flex flex-col sm:flex-row gap-1 sm:gap-8 text-sm">
					...
					<a href="#outras-areas" className="flex items-center justify-between py-2 text-primary hover:underline sm:py-0 sm:justify-start" onClick={(e) => scrollToSection(e, "outras-areas")}>
